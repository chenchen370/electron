    ...
    <el-row :span="24" :gutter="18">
      <el-col :span="6">
        <el-form-item label="提准字" prop="flowYear" style="width: 100%">
          <el-input style="width: 100%" v-model="queryParams.flowYear" placeholder="请输入" clearable
            @keyup.enter="onSearch" />
        </el-form-item>
      </el-col>
      <el-col :span="6">
        <el-form-item label="号" prop="flowNo" style="width: 100%">
          <el-input style="width: 100%" v-model="queryParams.flowNo" placeholder="请输入" clearable
            @keyup.enter="onSearch" />
        </el-form-item>
      </el-col>
      <el-col :span="6">
        <el-form-item label="提用人" prop="carryPerson" style="width: 100%">
          <el-input style="width: 100%" v-model="queryParams.carryPerson" placeholder="请输入" clearable
            @keyup.enter="onSearch" />
        </el-form-item>
      </el-col>
      <el-col :span="6">
      ...
      <el-col :span="6">
        <el-form-item label="退库状态" prop="backStatus" style="width: 100%">
          <el-select size="large" v-model="queryParams.backStatus" placeholder="请选择" clearable style="width: 100%">
            <el-option v-for="dict in backStatusList" :key="dict.value" :label="dict.label" :value="dict.value" />
          </el-select>
        </el-form-item>
      </el-col>
      ...
      <el-col :span="6">
        <div class="td-flex justify-end">
          <el-button class="button-c-primary" type="primary" @click="onSearch">搜索</el-button>

<template>
  <div>
    <el-table v-loading="loading" :data="tableList" @selection-change="handleSelectionChange" border>
      ...
      <el-table-column label="附属物名称" align="center" prop="accessoriesName" />
      <el-table-column label="附属物现状" align="center" prop="accessoriesCurrentStatus" />
      <el-table-column label="附属物数量" align="center" prop="accessoriesNumber" />
      <el-table-column label="附属物数量单位" align="center" prop="accessoriesUnitQuantity" />
...
function handleRowDelete(row) {
  emits('handleRowDelete', [row.id], row.accessoriesName)
}

function handleRowDetail(row) {
  const list = [
    { type: 'text', name: '附属物名称', value: row['accessoriesName'] },
    { type: 'text', name: '附属物现状', value: row['accessoriesCurrentStatus'] },
    { type: 'text', name: '附属物数量', value: row['accessoriesNumber'] },
    { type: 'text', name: '附属物数量单位', value: row['accessoriesUnitQuantity'] },
    { type: 'text', name: '附属物描述', value: row['accessoriesDescription'] },

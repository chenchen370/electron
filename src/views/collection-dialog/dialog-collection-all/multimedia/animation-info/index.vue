...
async function handleGetList() {
  try {
    const params = Object.assign({ mediaType: props.mediaType, relicNo: props.relicsId, relicId: props.relicsId }, searchParams.value, paginationParams)
    const res = await getMultimedia(params)

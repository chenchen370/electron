...
import { getCollectionAuditBillList } from '@/api/collection-info-manage'

const emits = defineEmits(['handleOpenMediaKindsList', 'handleAddCollection'])
/** 查询列表 */
...
async function handleGetList() {
  ...
  //
  const res = await getCollectionAuditBillList(params)

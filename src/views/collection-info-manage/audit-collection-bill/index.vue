  ...
  <div class="app-container">
    <el-card shadow="never" class="mb-10px">
      ...
      <div class="first-level" v-if="!isShowMediaKindsList">
        ...
        />
        <finished v-if="curtTabIndex === '1'" @handle-open-media-kinds-list="handleOpenMediaKindsList" @handle-open-collection-all="handleOpenCollectionAll" />
      </div>
    ...
    <dialog-collection-all
      ...
      :module-label-list="['藏品信息指标群', '藏品管理工作信息', '其他信息']"

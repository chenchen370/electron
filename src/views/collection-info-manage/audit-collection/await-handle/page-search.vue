<template>
  <el-form class="coder-wang-form" :model="queryParams" ref="queryRef" size="large" :inline="true" label-width="auto">
    <el-row :span="24" :gutter="18">
      ...
      <el-col :span="12">
        <el-form-item label="提交时间" prop="submitTimeArr" style="width: 100%">
          <el-date-picker
            style="width: 100%"
            v-model="queryParams.submitTimeArr"
            type="datetimerange"
...
function getParams() {
  ...
  if (queryParams?.submitTimeArr && queryParams.submitTimeArr.length > 0) {
    params.startTime = queryParams.submitTimeArr[0]
    params.endTime = queryParams.submitTimeArr[1]
  }
  delete params.submitTimeArr
  return params
}

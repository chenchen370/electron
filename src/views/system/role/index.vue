<template>
  <div class="app-container td-px10 td-pt10">
    <el-form :model="queryParams" ref="queryRef" v-show="showSearch" :inline="true" label-width="68px" class="mb-10px">
    ...
    <!-- 分配角色数据权限对话框 -->
    <el-dialog :title="title" v-model="openDataScope" width="500px" append-to-body align-center :show-close="false">

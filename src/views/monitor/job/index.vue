<template>
  <div class="app-container">
    ...
    <!-- 添加或修改定时任务对话框 -->
    <el-dialog :title="title" v-model="open" width="820px" append-to-body align-center :show-close="false">
                  ...
                  <el-tooltip placement="top">
                    <template #content>
                      <div>
                        ...
                        <br />Class类调用示例：com.zhebo.quartz.task.RyTask.ryParams('ry')
    ...
    <el-dialog title="Cron表达式生成器" v-model="openCron" append-to-body destroy-on-close align-center :show-close="false">
      <crontab ref="crontabRef" @hide="openCron = false" @fill="crontabFill" :expression="expression"></crontab>
    </el-dialog>

    <!-- 任务日志详细 -->
    <el-dialog title="任务详细" v-model="openView" width="700px" append-to-body align-center :show-close="false">

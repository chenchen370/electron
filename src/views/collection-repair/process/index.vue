...
import { delRepairProcess, listRepairProcess } from '@/api/collection/repairProcess.ts'
import { listRepair } from '@/api/collection/repair.ts'
import { listMaterial } from '@/api/collection/material.ts'
...
async function handleGetList() {
  try {
    ...
    const res = (await listRepairProcess(params)) as any

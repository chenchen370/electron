<template>
  <el-row :gutter="10" class="mb8">
    <el-col :span="1.5">
      <comm-handle-btn :per="['collection-repair:material:add']" title="新增" img-name="add" @handle-click="handleAdd" />
    </el-col>
    <el-col :span="1.5">
      <comm-handle-btn :per="['collection-repair:material:update']" title="修改" img-name="edit" :disabled="single" @handle-click="handleUpdate" />
    </el-col>
    <el-col :span="1.5">
      <comm-handle-btn :per="['collection-repair:material:delete']" title="删除" img-name="remove" :disabled="multiple" @handle-click="handleDelete" />
    </el-col>

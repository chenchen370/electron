<template>
  <div class="app-container">
    <el-card shadow="never" class="mb-10px">
      <page-search :proxy="proxy" :options-info="options_info" :show-search="headerBtnInfo.showSearch" @handle-search="handleSearch" />
...
import { delRepair, listRepair } from '@/api/collection/repair.ts'
...
async function handleGetList() {
  try {
    ...
    const res = (await listRepair(params)) as any

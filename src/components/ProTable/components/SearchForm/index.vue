      ...
      <Grid ref="gridRef" :collapsed="collapsed" :collapsed-rows="collapsedRows" :gap="[10, 10]" :cols="searchCol">
        ...
        <GridItem suffix>
          <div class="el-protable-search__content-action">
            <el-button class="button-c-primary" type="primary" :icon="Search" @click="search"> 搜索</el-button>
            <el-button class="button-p-black" :icon="Delete" @click="reset"> 重置</el-button>
...
defineOptions({ name: 'ProTableSearchForm' })
...
const showCollapse = computed(() => {
  ...
  props.columns.reduce((prev, current) => {
    ...
    prev += (typeof span == 'object' ? span[breakPoint.value] ?? 1 : span) + (typeof offset === 'object' ? offset[breakPoint.value] ?? 0 : offset)
